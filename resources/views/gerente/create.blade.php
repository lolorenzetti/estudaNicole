...
<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
      ...
      <a class="menudados" href="/projeto">Projetos</a>
        ...
        <h1 styles="align-content:center; margin-bottom: 10px "class="">Novo Gerente</h1>
        <form class="login100-form validate-form" method="post" action="/gerente">
        @csrf
        @method("post")
 <div styles="text-align: center">
    ...
    <div class="form-group" data-validate="especialidade">
    <label for="">Especialidade</label>
      <input class="form-control" type="text" name="especialidade" placeholder="Especialidade" require>
    </div>
